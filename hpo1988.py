	...
	try:
		...
		try:
			...
			yes = dialog.yesno(
				...
				Bạn cần nhập tài khoản'[COLOR red]VIP FShare[/COLOR]' để xem!Nếu chưa có tài khoản thì liên hệ qua**'[COLOR yellow]FB:tranhuyhoang HOẶC ZALO:0974 090 325[/COLOR]' để đăng ký tài khoản VIP ngay bây giờ!,
